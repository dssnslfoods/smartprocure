...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        heading: 'หน้า "เกณฑ์ความเสี่ยง" (เมนูผู้จัดจำหน่าย)',
        points: [
          'ปรับได้ทุกอย่างผ่านหน้าจอ ไม่ต้องแก้ระบบ',
          'สัดส่วนน้ำหนักความปลอดภัย/เชิงพาณิชย์ ต่อหมวดผู้ขาย + ตั้งค่าขั้นต่ำ',
          'คะแนนรายตัวเลือก · เพิ่ม/ลบตัวเลือก · คำค้นสำหรับจับคู่อัตโนมัติ',
          'คะแนนเต็มของหัวข้อ และวิธีรวมคะแนน (เลือกสูงสุด / บวกสะสม)',
          'ช่วงคะแนนเกรด A/B/C/D ต่อหมวด',
          'สร้างหัวข้อใหม่เองได้ ("+ เพิ่มหัวข้อใหม่") รองรับแบบ 3 ระดับ เช่น 15/10/0',
          'สร้างหมวด (Section) ใหม่ได้ — พิมพ์ชื่อหมวดใหม่ในช่อง "หมวด" ระบบสร้างให้อัตโนมัติ',
          'ตั้ง/ยกเลิก "เอกสารบังคับ" รายตัวเลือก',
          'ปิดใช้งานหัวข้อชั่วคราวด้วยสวิตช์ (เก็บประวัติไว้) หรือลบถาวรด้วยปุ่มถังขยะ',
          'การลบหัวข้อจะลบตัวเลือก ผลประเมิน และเอกสารที่ผูกอยู่ด้วย — ระบบแจ้งจำนวนก่อนยืนยันเสมอ',
          'การเปลี่ยนน้ำหนักต้องยืนยันก่อน และถูกบันทึกใน Audit Log (ดูได้ที่ปุ่ม "ประวัติ")',
        ],
      },
    ],
  },
